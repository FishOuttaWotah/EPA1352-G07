...
class Infra(Agent):
    ...
    generated_at_step, removed_at_step : int
        Step at which Agent is generated/removed. Not used for Infra, but necessary for datacollection to run in model_run.py

    array_of_removal : list
        List with relevant Agent parameters. Not used for Infra, but necessary for datacollection to run in model_run_batch.py
    ...
    ...
    def __init__(self, unique_id, model, length=0,
        ...
        # Initialize variables for datacollection in model_run.py (only relevant for Vehicle class)
        self.generated_at_step = 0
        self.removed_at_step = 0
        # Initialize array for datacollection (only relevant for Sink class)
        self.array_of_removal = []
...
class Sink(Infra):
    ...
    def remove(self, vehicle):
        ...
        self.array_of_removal.append(vehicle.make_record_array())
...
class Vehicle(Agent):
    ...
    array_of_removal: list
        Variables for removed vehicles. Only relevant in Sink class, 
        but included for datacollection in model_run_batch.py
    ...
    ...
    def __init__(self, unique_id, model, generated_by,
        ...
        self.array_of_removal = []  # Initialize array for datacollection (used in Sink class only)
    ...
    def make_record_array(self):
        """
        Output a list of relevant variables of the vehicle, 
        to be called in Sink class, when vehicle reaches sink and is removed.
        """
